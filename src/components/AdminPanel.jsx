...
export default function AdminPanel() {
  ...
  const subTabs = [
    ...
    { id: "THEME", label: "Theme & Comfort", icon: Settings, show: true },
    {
      ...
      icon: Users,
      show: hasPermission("User Management", "Full"),
    },
    {
      id: "ROLE_MGMT",
      label: "Role Management",
      icon: Shield,
      show: hasPermission("Role Management", "Full"),
    },
    {
      id: "AUDIT_LOGS",
      label: "Audit Logs",
      icon: Terminal,
      show: userProfile?.role === "SUPER_ADMIN",
    },
  ];
  ...
  useEffect(() => {
    if (
      ...
      !allowedSubTabs.some((t) => t.id === activeSubTab)
    ) {
