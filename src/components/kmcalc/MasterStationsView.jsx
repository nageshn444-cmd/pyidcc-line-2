      ...
      {(showAddForm || editingStation) && (
        <div className="bg-slate-900 border border-slate-800 rounded p-4 shadow-lg animate-fadeIn">
          ...
          <form onSubmit={editingStation ? handleEditSave : handleAdd} className="grid grid-cols-1 md:grid-cols-4 gap-3">
            <div>
              <label className="block text-[10px] font-mono uppercase text-slate-400 mb-1">Station Code (e.g. PYID)</label>
              <input
            ...
            <div>
              <label className="block text-[10px] font-mono uppercase text-slate-400 mb-1">Station Name</label>
              <input
            ...
            <div>
              <label className="block text-[10px] font-mono uppercase text-slate-400 mb-1">Chainage in KM (e.g. -3.02)</label>
              <input
            ...
            <div className="flex flex-col justify-end">
              <label className="flex items-center gap-2 cursor-pointer py-1 text-[11px] text-slate-300 font-mono">
                <input
