...
export const DAY_TYPE_PROFILES = {
  WEEKDAY: {
    ...
    or_model: "LADDER",
    type_casing: "MIXED",
    spacers_after: [7, 13, 24, 30, 42, 53, 60, 68, 74],
    or1_times: { on: 0.27083, off: 0.60417 },
    or2_times: { on: 0.58333, off: 0.91667 },
    description: "Standard Weekday Timetable Link (75 duties)"
  },
  MON: {
    id: "MON",
